...
/****** Object:  Database [ATM_Db]    Script Date: 08/12/2022 12:43:02 ******/
CREATE DATABASE [ATM_Db]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ATM_Db', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\ATM_Db.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ATM_Db_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\ATM_Db_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [ATM_Db] SET AUTO_CLOSE OFF 
GO
...
ALTER DATABASE [ATM_Db] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [ATM_Db] SET QUERY_STORE = OFF
GO
